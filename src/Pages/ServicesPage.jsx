  ...
  return (
    ...
    >
      ...
      <div className=" flex-col flex w-5/6 m-auto mb gap-4 sm:flex-row justify-center items-center">
         ...
         <div className="sm:w-1/3 w-2/3 relative " onClick={()=>navigate('/TeachRica/service-modal')}>
      ...
      <div className=" flex-col flex w-5/6 m-auto gap-4 sm:flex-row justify-center items-center">
        <div className="sm:w-1/3 w-2/3 relative">
          <img src={serviceOne} alt="" className="w-96 block m-auto mt-20" />
          <p className="text-2xl font-bold text-start mt-2 p-3">
            Soft Skills Courses
          </p>
          <p className="text-base pl-3">
        ...
        <div className="sm:w-1/3 w-2/3 relative">
          <img src={serviceTwo} alt="" className="w-96 block m-auto mt-20" />
          <p className="text-2xl font-bold text-start mt-2 p-3">
            Online Tuition
          </p>
          <p className="text-base pl-3">
      ...
      </div> <div className=" flex-col flex w-5/6 m-auto gap-4 sm:flex-row justify-center items-center">
        <div className="sm:w-1/3 w-2/3 relative">
          <img src={serviceOne} alt="" className="w-96 block m-auto" />
          <p className="text-2xl font-bold text-start mt-2 p-3">
            Soft Skills Courses
