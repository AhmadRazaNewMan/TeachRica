...
const ServiceModal = () => {
  return (
    <div>
      ...
      <CommonHeader />
      <div className="shadow-lg shadow-cyan-500/50  h-auto w-[50vw] mx-auto mb-28">
        <div className="flex  w-full h-80 my-10">
          <div className="flex">
            ...
            <div className=" ml-5   items-start">
        ...
        <div className="bg-bluePrimary h-20 w-full mt-20 flex space-x-[450px]">
